...
def main():
    ...
    # Glob mode: repo_root/tests/hui-compress/
    # __file__ lives at <repo_root>/skills/hui-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → hui-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "hui-compress"
