...
2. Otherwise download and run the standalone script (it is self-contained and supports stdin execution): `curl -fsSL https://raw.githubusercontent.com/everything-ok/next-token/main/src/tools/hui-init.js | node - $ARGUMENTS`
