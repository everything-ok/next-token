...
#        irm https://raw.githubusercontent.com/everything-ok/next-token/main/src/hooks/install.ps1 | iex
...
$RepoUrl = "https://raw.githubusercontent.com/everything-ok/next-token/main/src/hooks"
