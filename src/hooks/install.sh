...
#   or:  bash <(curl -s https://raw.githubusercontent.com/everything-ok/next-token/main/src/hooks/install.sh)
...
REPO_URL="https://raw.githubusercontent.com/everything-ok/next-token/main/src/hooks"
