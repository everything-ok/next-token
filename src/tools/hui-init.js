...
//   curl -fsSL https://raw.githubusercontent.com/2454760302hui/next-token/main/src/tools/hui-init.js | node - [args]
//
...
const AGENTS = [
  { id: 'cursor',   file: '.cursor/rules/hui.mdc',
    frontmatter: '---\ndescription: "Hui mode — terse communication, 65% fewer output tokens (measured), full technical accuracy"\nalwaysApply: true\n---\n\n',
    mode: 'replace' },
...
Usage: hui-init.js [target-dir] [--dry-run] [--force] [--only <agent>]
