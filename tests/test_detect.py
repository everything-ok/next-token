...
compressible natural language — so `/hui-compress Dockerfile` would
overwrite a Dockerfile with hui prose. These tests pin the basename
and shebang guards.
"""
...
sys.path.insert(0, str(REPO_ROOT / "skills" / "hui-compress"))
